...
interface ListingCardProps {
  ad: Ad;
  userId?: string | undefined; // You need to pass the logged-in user's ID
}
      ...
      <CardContent className="p-0" onClick={handleClick}>
        <div className="relative">
          <Carousel className="w-full">
            ...
            {/* Prevent the onClick event from propagating to the Card when arrows are clicked */}
          ...
          {!isOwnAd && (
            <Button
              ...
              onClick={(e) => {
                e.stopPropagation(); // Prevent the onClick event from propagating
                toggleFavorite();
              }}
            >
              <Heart
